...
Clean, modular Neovim configuration based on Kickstart.nvim
with CMake integration and automatic quickfix support.
    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          if not event.buf or type(event.buf) ~= "number" or not vim.api.nvim_buf_is_valid(event.buf) then
            return
          end
      ...
      -- Setup cmp-nvim-lsp capabilities (should work with Neovim 0.11+)
